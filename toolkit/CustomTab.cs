...
namespace toolkit
{
    public class CustomTabControl : TabControl
    {
        ...
        private Color _tabColor = Color.Black;
        ...
        internal void DrawControl(Graphics g)
        {
            try
            {
                ...
                for (int i = 0; i < TabCount; i++)
                {
                    ...
                    TabPages[i].BackColor = Color.FromArgb(((int)(((byte)(55)))), ((int)(((byte)(55)))), ((int)(((byte)(55)))));
                }
        ...
        internal void DrawTab(Graphics g, TabPage customTabPage, int nIndex)
        {
            ...
            //rectangleF.Y += 0;
            brush = isSelected ? new SolidBrush(Color.White) : new SolidBrush(Color.Gray);
